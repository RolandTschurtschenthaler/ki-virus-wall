...
const DEMO_PEOPLE = [
  { id: "1", name: "Reinhold", role: "CEO", infected: false },
  { id: "2", name: "Daniel", role: "Head of Sales & Consulting", infected: false },
  { id: "3", name: "Dietmar", role: "Consultant", infected: false },
  { id: "4", name: "Ulrike", role: "Sales Manager Tourism Portals", infected: false },
  { id: "5", name: "Marion", role: "Sales Manager Tourism Portals", infected: false },
  { id: "6", name: "Manuel", role: "Team Leader Sales", infected: false },
  { id: "7", name: "Nadia", role: "Full Stack Developer", infected: false },
  { id: "8", name: "Carmen", role: "Front-End Artist Tourism Portals", infected: false },
  { id: "9", name: "Monika", role: "Head of Web Development & Graphics", infected: false },
  { id: "10", name: "Ruth", role: "Text Artist", infected: false },
  { id: "11", name: "Renate", role: "Accounting Manager", infected: false },
  { id: "12", name: "Stefan", role: "Head of Communication & Marketing", infected: false },
  { id: "13", name: "Sandra", role: "Front-End Artist Web", infected: false },
  { id: "14", name: "Julian", role: "Software Developer", infected: false },
  { id: "15", name: "Karin", role: "Consultant", infected: false },
  { id: "16", name: "Elisabeth", role: "Art Director", infected: false },
  { id: "17", name: "Marina", role: "Payroll Manager", infected: false },
  { id: "18", name: "Angelika", role: "Front-End Artist Tourism Portals", infected: false },
  { id: "19", name: "Ivan", role: "J.CEO & CTO", infected: false },
  { id: "20", name: "Florian", role: "Head of Backoffice & Controlling", infected: false },
  { id: "21", name: "Armin", role: "Team Leader SEO & Advertising", infected: false },
  { id: "22", name: "Christoph", role: "Team Leader Web & Design", infected: false },
  { id: "23", name: "Julia", role: "Text Artist", infected: false },
  { id: "24", name: "Christoph", role: "SEM Manager", infected: false },
  { id: "25", name: "Evelyn", role: "Head of Tourism Portals", infected: false },
  { id: "26", name: "Manuel", role: "Full Stack Developer", infected: false },
  { id: "27", name: "Uschi", role: "Front-End Artist Web", infected: false },
  { id: "28", name: "Lisa", role: "Consultant", infected: false },
  { id: "29", name: "Andreas", role: "Text Artist", infected: false },
  { id: "30", name: "Jasmin", role: "Consultant & Content Artist", infected: false },
  { id: "31", name: "Stefanie", role: "SEM Manager", infected: false },
  { id: "32", name: "Hannes", role: "Service Desk & IT Support", infected: false },
  { id: "33", name: "Marion", role: "Team Leader Consulting", infected: false },
  { id: "34", name: "Andreas", role: "Software Developer", infected: false },
  { id: "35", name: "Johanna", role: "Head of Product Management", infected: false },
  { id: "36", name: "Julia", role: "SEO Manager", infected: false },
  { id: "37", name: "Nadja", role: "Human Resource Manager", infected: false },
  { id: "38", name: "Caroline", role: "Consultant", infected: false },
  { id: "39", name: "Fabian", role: "Software Developer", infected: false },
  { id: "40", name: "Katharina", role: "Text Artist", infected: false },
  { id: "41", name: "Alan", role: "SEM Manager", infected: false },
  { id: "42", name: "Mario", role: "Service Desk & IT Support", infected: false },
  { id: "43", name: "Martin", role: "Project Manager", infected: false },
  { id: "44", name: "Franziska", role: "Front-End Artist Web", infected: false },
  { id: "45", name: "Anna", role: "SEO Manager", infected: false },
  { id: "46", name: "Elisabeth", role: "Consultant", infected: false },
  { id: "47", name: "Daniel", role: "Front-End Artist Web", infected: false },
  { id: "48", name: "Barbara", role: "Organizational Development Manager", infected: false },
  { id: "49", name: "Pierre", role: "Sales & Project Manager", infected: false },
  { id: "50", name: "Sonja", role: "Consultant", infected: false },
  { id: "51", name: "Norah", role: "Consultant", infected: false },
  { id: "52", name: "Simon", role: "Software Developer", infected: false },
  { id: "53", name: "Roland", role: "Project Manager", infected: false },
  { id: "54", name: "Judith", role: "Creative Designer & Brand Manager", infected: false },
  { id: "55", name: "Tobias", role: "SEO Manager", infected: false }
];
