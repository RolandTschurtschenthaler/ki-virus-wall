...
// —— KI‑Virus Kachelübersicht ——
// Features:
// • Kachelgrid wie "Squid Game"-Wallboard
// • Mitarbeiter als Karten; "infiziert" = leuchtender Glow + Puls-Animation
// • Suche, Filter (alle / infiziert / nicht infiziert), Team-Filter
// • Fortschrittsbalken (x von n überzeugt)
// • CSV-Import (name,team,role[,infected]) & Reset; lokale Persistenz via localStorage
// • Alles in einem File, keine Backend-Abhängigkeit
...
export default function KIVirusWall() {
